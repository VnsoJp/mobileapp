...
//message
const msgtxt1 = '<p class="image"><img src = "img/penguins.jpg" widthh=61px height=61px></p><p class="text">Penguins Attack!</p>';
const msgtxt2 = '<p class="image"><img src = "img/whitebear.jpg" widthh=61px height=61px></p><p class="text">WhiteBear Attack!</p>';
