...
const omukujiText = document.getElementById("omikujiText");
...
function() {
    ...
    // let resultColor = ["#ff0000","#ffa500","#261e1c","#00ff00","#0000ff","#ffff00"];
    // let resultFontSize = ["90px","80px","70px","60px","50px","40px"];
    let n = Math.floor(Math.random() * resultText.length);
    // omukujiText.textContent = resultText[n];
    // omukujiText.style.color = resultColor[n];
    // omukujiText.style.fontSize = resultFontSize[n];
