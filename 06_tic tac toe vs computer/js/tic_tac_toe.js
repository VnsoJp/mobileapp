"use strict";
// pen-flag =penguins, bear-flag = bear.
let flag = "pen-flag";
...
//message
const msgtxt1 = '<p class="image"><img src = "img/penguins.jpg" widthh=61px height=61px></p><p class="text">Penguins Attack! (your turn)</p>';
const msgtxt2 = '<p class="image"><img src = "img/whitebear.jpg" widthh=61px height=61px></p><p class="text">WhiteBear Attack! (computer turn)</p>';
